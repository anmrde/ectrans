...
MODULE SUPOL_TEST_MOD
CONTAINS
SUBROUTINE SUPOL_TEST(KNSMAX,PDDMU,PFN,PDDPOL)

!**** *SUPOL_TEST * - Copy of the routine supol to compute associated Legendre polynomials
! This routine should only be used for testing the correctness of the results produced by ectrans!
! It is separate from the main supol code in ectrans to help identify when code changes might affect
...
END SUBROUTINE SUPOL_TEST
END MODULE SUPOL_TEST_MOD
