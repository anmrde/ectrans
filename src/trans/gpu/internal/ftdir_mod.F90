...
integer :: istat, idev
REAL(KIND=JPRBT), ALLOCATABLE, TARGET :: ZGTF2(:,:)
...
#ifdef ACCGPU
!$ACC DATA &
!$ACC& PRESENT(ZGTF,D_NSTAGTF,D_NPTRLS,G_NMEN,G_NMEN_MAX,G_NLOEN,G_NLOEN_MAX,R_NNOEXTZL)
#endif
#ifdef OMPGPU
!$OMP TARGET DATA &
!$OMP& MAP(ALLOC:ZGTF,D,D_NSTAGTF,D_NPTRLS,G_NMEN,G_NMEN_MAX,G_NLOEN,G_NLOEN_MAX,R_NNOEXTZL)
#endif
...
#endif
#ifdef OMPGPU
  !!$OMP TARGET DATA USE_DEVICE_PTR(ZGTF,ZGTF2)
#endif
...
!$ACC&    PRESENT(G_NLOEN,G_NMEN,D_NSTAGTF,ZGTF,R_NNOEXTZL) &
!$ACC&    COPYIN(OFFSET_VAR,IBEG,IEND,IINC,IMAX,KFIELDS)
#endif
